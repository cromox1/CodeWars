class Calculator(object):
    def evaluate(self, string):
        ...
        # numbers = [i for i in range(len(liststring)) if type(int(liststring[i])) == int]
        timediv = {i:liststring[i] for i in range(len(liststring)) if liststring[i] == '/' or liststring[i] == '*'}
        sumsub = {i:liststring[i] for i in range(len(liststring)) if liststring[i] == '+' or liststring[i] == '-'}
        print(frontclose)
        print(backclose)
        # print(numbers)
        print(timediv)
